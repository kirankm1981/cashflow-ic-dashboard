...
export async function ensureSchema() {
  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS cashflow_excluded_entities (
        id SERIAL PRIMARY KEY,
        company TEXT NOT NULL,
        reason TEXT,
        excluded_at TEXT
    ...
    `);
    await client.query(`CREATE INDEX IF NOT EXISTS cf_excluded_company_idx ON cashflow_excluded_entities (company)`);

    await client.query(`
      CREATE TABLE IF NOT EXISTS ic_rpt_audit_entries (
        id SERIAL PRIMARY KEY,
        entity_company_code TEXT NOT NULL,
        entity_name TEXT,
        rpt_ledger TEXT NOT NULL,
        rpt_counter_party_code TEXT,
        rpt_counter_party_name TEXT,
        amount DOUBLE PRECISION NOT NULL,
        nature_of_balance TEXT,
        narration TEXT,
        ic_txn_type TEXT,
        rpt_txn_type TEXT,
        ic_type TEXT,
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS ic_entity_list (
        id SERIAL PRIMARY KEY,
        short_name TEXT NOT NULL,
        company_name TEXT,
        company_name_erp TEXT,
        doi_conversion TEXT,
        entity_type TEXT,
        project TEXT,
        structure TEXT,
    ...
    const alterStatements = [
      ...
      "ALTER TABLE summarized_lines ADD COLUMN IF NOT EXISTS ic_txn_type TEXT",
      ...
      "ALTER TABLE ic_matrix_tb_data ADD COLUMN IF NOT EXISTS rpt_txn_type TEXT",
      "ALTER TABLE ic_matrix_tb_data ADD COLUMN IF NOT EXISTS rpt_group TEXT",
      "ALTER TABLE ic_matrix_tb_data ADD COLUMN IF NOT EXISTS current_non_current TEXT",
      "ALTER TABLE ic_matrix_tb_data ADD COLUMN IF NOT EXISTS fs_group TEXT",
      "ALTER TABLE ic_matrix_tb_data ADD COLUMN IF NOT EXISTS fs_heading TEXT",
      "ALTER TABLE ic_matrix_mapping_gl ADD COLUMN IF NOT EXISTS gl_name TEXT",
      "ALTER TABLE ic_matrix_mapping_gl ADD COLUMN IF NOT EXISTS rpt_txn_type TEXT",
      "ALTER TABLE ic_matrix_mapping_gl ADD COLUMN IF NOT EXISTS rpt_group TEXT",
      "ALTER TABLE ic_matrix_mapping_gl ADD COLUMN IF NOT EXISTS current_non_current TEXT",
      "ALTER TABLE ic_matrix_mapping_gl ADD COLUMN IF NOT EXISTS fs_group TEXT",
      "ALTER TABLE ic_matrix_mapping_gl ADD COLUMN IF NOT EXISTS fs_heading TEXT",
      "ALTER TABLE ic_matrix_mapping_company ADD COLUMN IF NOT EXISTS company_name_erp TEXT",
      "ALTER TABLE ic_matrix_mapping_company ADD COLUMN IF NOT EXISTS \"group\" TEXT",
      ...
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS activity_type TEXT",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS cf_statement_line TEXT",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS pl_category TEXT",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS pl_sign DOUBLE PRECISION DEFAULT 0",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS wip_component TEXT",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS wc_bucket TEXT",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS wc_sign DOUBLE PRECISION DEFAULT 0",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS debt_bucket TEXT",
      "ALTER TABLE cashflow_mapping_groupings ADD COLUMN IF NOT EXISTS kpi_tag TEXT",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS activity_type TEXT",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS cf_statement_line TEXT",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS pl_category TEXT",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS pl_sign DOUBLE PRECISION DEFAULT 0",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS wip_component TEXT",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS wc_bucket TEXT",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS wc_sign DOUBLE PRECISION DEFAULT 0",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS debt_bucket TEXT",
      "ALTER TABLE cashflow_tb_data ADD COLUMN IF NOT EXISTS kpi_tag TEXT",
      "ALTER TABLE ic_matrix_tb_files ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'uploaded'",
      "ALTER TABLE ic_matrix_tb_files ADD COLUMN IF NOT EXISTS status_message TEXT",
      "ALTER TABLE cashflow_tb_files ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'uploaded'",
      "ALTER TABLE cashflow_tb_files ADD COLUMN IF NOT EXISTS status_message TEXT",
      "ALTER TABLE upload_batches ADD COLUMN IF NOT EXISTS uploaded_at TEXT",
      "ALTER TABLE ic_recon_gl_raw_rows ADD COLUMN IF NOT EXISTS batch_id TEXT",
      "ALTER TABLE ic_recon_gl_files ADD COLUMN IF NOT EXISTS batch_id TEXT",
      "ALTER TABLE ic_recon_gl_files ADD COLUMN IF NOT EXISTS enterprise_name TEXT",
      "ALTER TABLE ic_recon_gl_files ADD COLUMN IF NOT EXISTS report_period TEXT",
      "ALTER TABLE ic_recon_gl_files ADD COLUMN IF NOT EXISTS ic_records INTEGER DEFAULT 0",
      "ALTER TABLE ic_recon_gl_files ADD COLUMN IF NOT EXISTS processed BOOLEAN NOT NULL DEFAULT false",
      "ALTER TABLE ic_recon_gl_files ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'uploaded'",
      "ALTER TABLE ic_recon_gl_files ADD COLUMN IF NOT EXISTS status_message TEXT",
    ];
    ...
    const existingGlFiles = await client.query(
      `UPDATE ic_recon_gl_files SET processed = true WHERE processed = false AND ic_records > 0 RETURNING id`
    );
    if (existingGlFiles.rowCount && existingGlFiles.rowCount > 0) {
      console.log(`[migrate] Marked ${existingGlFiles.rowCount} existing GL files as processed`);
    }
