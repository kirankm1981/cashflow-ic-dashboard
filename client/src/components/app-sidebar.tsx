...
function getIcReconItems(isViewer: boolean) {
  const items = [
    ...
    { title: "RPT Transaction Data", url: "/recon/rpt-data", icon: Database },
    { title: "RPT Reports", url: "/recon/rpt-reports", icon: FileText },
            ...
            <div className="flex items-center gap-3 cursor-pointer group">
              <div className="relative w-10 h-10 shrink-0">
                <svg viewBox="0 0 40 40" className="w-full h-full drop-shadow-lg">
                  <defs>
                    <linearGradient id="sb-shield" x1="20" y1="2" x2="20" y2="38" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#34d399" />
                      <stop offset="0.5" stopColor="#14b8a6" />
                      <stop offset="1" stopColor="#2563eb" />
                    </linearGradient>
                  </defs>
                  <path d="M20 2L4 10V22C4 30 11 36.5 20 38C29 36.5 36 30 36 22V10L20 2Z" fill="url(#sb-shield)" />
                  <rect x="12" y="22" width="4" height="8" rx="1" fill="white" opacity="0.9" />
                  <rect x="18" y="16" width="4" height="14" rx="1" fill="white" opacity="0.9" />
                  <rect x="24" y="19" width="4" height="11" rx="1" fill="white" opacity="0.9" />
                </svg>
              </div>
              <div>
                <p className="text-[13px] font-bold tracking-tight text-white leading-tight" data-testid="text-app-name">Assetz Strata</p>
                <p className="text-[10px] text-slate-400 font-medium tracking-widest uppercase">Enterprise</p>
              </div>
            </div>
          </Link>
        </SidebarHeader>
