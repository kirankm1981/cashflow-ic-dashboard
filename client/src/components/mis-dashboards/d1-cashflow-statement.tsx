...
import { ChevronDown, ChevronRight, TrendingUp, TrendingDown, ArrowRightLeft, Download } from "lucide-react";
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  downloadExcel([sheet], `Indirect_CF_Statement_${new Date().toISOString().slice(0, 10)}.xlsx`);
                }}
                disabled={cfTable.length === 0}
                data-testid="button-download-cf-statement"
              >
