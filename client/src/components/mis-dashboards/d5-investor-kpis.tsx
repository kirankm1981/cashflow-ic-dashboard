...
const KPI_DEFS: { tag: string; useClosing: boolean; abs: boolean; color: string; flow: FlowColor }[] = [
  { tag: "Revenue Billed", useClosing: true, abs: true, color: "#22c55e", flow: "inflow" },
  { tag: "Collections", useClosing: true, abs: true, color: "#3b82f6", flow: "inflow" },
