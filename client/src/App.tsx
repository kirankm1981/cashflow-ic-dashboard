...
import RptReportsPage from "@/pages/rpt-reports";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/recon/rpt-reports">{() => <ErrorBoundary><ModuleGuard module="ic_recon" component={RptReportsPage} /></ErrorBoundary>}</Route>
