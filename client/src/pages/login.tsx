        ...
        <CardHeader className="text-center space-y-4 pb-2">
          <div className="mx-auto w-16 h-16">
            <svg viewBox="0 0 40 40" className="w-full h-full drop-shadow-xl">
              <defs>
                <linearGradient id="lg-shield" x1="20" y1="2" x2="20" y2="38" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#34d399" />
                  <stop offset="0.5" stopColor="#14b8a6" />
                  <stop offset="1" stopColor="#2563eb" />
                </linearGradient>
              </defs>
              <path d="M20 2L4 10V22C4 30 11 36.5 20 38C29 36.5 36 30 36 22V10L20 2Z" fill="url(#lg-shield)" />
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-medium tracking-[0.2em] uppercase mt-1">Enterprise Platform</p>
